...
<template>
    <main class="w-full h-screen flex flex-col items-center justify-center">
        <form @submit="handleRegister" class="shadow-lg shadow-gray-500 rounded-2xl  w-1/4 h-4/5 flex flex-col items-center p-5 bg-gray-700">
            ...
            <div class="w-full h-1/5 flex flex-col justify-center mb-2 px-4 gap-1.5">
            ...
            <div class="w-full h-1/5 flex flex-col justify-center px-4 mb-2 gap-1.5">
                <label for="password_user" class="text-md text-white tracking-widest">Contraseña</label>
                <input
            ...
            <a class="text-white text-md mt-2 underline" href="/">¿Ya tienes una cuenta? Inicia sesión</a>
            <button 
                class="my-5 w-4/5 h-12 outline-none rounded-3xl text-lg tracking-wider bg-green-600 text-white font-semibold hover:bg-green-700 cursor-pointer hover:text-white transition-colors" 
                type="submit">
                Registrarse
            </button>
        </form>
